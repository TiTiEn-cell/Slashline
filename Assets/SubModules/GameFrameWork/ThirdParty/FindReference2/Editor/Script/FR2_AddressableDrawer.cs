...
{
    public class FR2_AddressableDrawer : IRefDraw
    {
        ...
        {
            { ProjectStatus.None, "-" },
            { ProjectStatus.NoSettings, "Addressable: No settings created!" },
            { ProjectStatus.NoGroup, "Addressable: No Bundle Group created!" },
            { ProjectStatus.Ok, "-" },
        };

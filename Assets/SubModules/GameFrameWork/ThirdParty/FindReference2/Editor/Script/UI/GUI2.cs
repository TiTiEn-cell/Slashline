...
namespace vietlabs.fr2
{
    ...
    public static class GUI2
    {
        ...
        public static Object[] DropZone(string title, float w, float h)
        {
            ...
            Color(() => { GUI.DrawTexture(plusRect, FR2_Icon.Plus.image, ScaleMode.ScaleToFit); }, UnityEngine.Color.white, 0.1f);
		...
		{
			var guiContent = FR2_GUIContent.From(label);
        ...
        {
        	//TODO: FIX GC
        	var vv = GUI.Toggle(r, value, FR2_GUIContent.Tooltip(tooltip), EditorStyles.toolbarButton);
        ...
        public static bool ToolbarToggle(ref bool value, Texture icon, Vector2 padding, string tooltip, Rect position)
        {
            ...
            bool newValue = GUI.Toggle(position, value, FR2_GUIContent.FromTexture(icon, tooltip), EditorStyles.toolbarButton);
        ...
        internal static bool ToolbarToggle(ref bool value, Texture icon, Vector2 padding, string tooltip = null)
        {
            ...
            {
                vv = GUILayout.Toggle(value, FR2_GUIContent.Tooltip(tooltip), EditorStyles.toolbarButton, GUI2.GLW_24);
                if (icon != null)
                {
        ...
        //     bool oldValue = value;
        //     value = GUI.Toggle(rect, value, FR2_GUIContent.Tooltip(tooltip), EditorStyles.toolbarButton);
        //     Profiler.EndSample();
        //     
        ...
        // 	//if (Event.current.type == EventType.Repaint)
        // 	{
        // 		EditorGUILayout.LabelField(FR2_GUIContent.FromString("Hello"), style, options);
        // 	}

...
namespace SuperScrollView
{
    ...
    public class LoopListViewInitParam
    {
        ...
        public float mDistanceForRecycle1 = 700;//mDistanceForRecycle1 should be larger than mDistanceForNew1
        public float mDistanceForNew1 = 600;
        ...
        public static LoopListViewInitParam CopyDefaultInitParamDiscovery()
        {
            LoopListViewInitParam item = new LoopListViewInitParam();
            item.mDistanceForRecycle0        = 200; ////mDistanceForRecycle0 should be larger than mDistanceForNew0
            item.mDistanceForNew0            = 100;
            item.mDistanceForRecycle1        = 1600f;//mDistanceForRecycle1 should be larger than mDistanceForNew1
            item.mDistanceForNew1            = 1400f;
            item.mSmoothDumpRate             = 0.3f;
            item.mSnapFinishThreshold        = 0.01f;
            item.mSnapVecThreshold           = 145;
            item.mItemDefaultWithPaddingSize = 200;
            return item;
        }
    }
